...
**Props** must be first class citizens in your application code base, and you should try to achieve all possible _flavors_ or variants of your components with them whenever possible.
...
{% blockquote 'Simplicity is a prerequisite for reliability.' 'Edsger W. Dijkstra' %}
...
It's better to treat it as a _prop_ in case a parent component holds this value or moves it outside the component as a constant value.
...
If you find yourself writing too many `shouldComponentUpdate` functions or the logic inside of them is too complex, try raising states to a higher component and pass _props_ to less complex ones.

## Wrap-up

Deferring to _stateless_ components over _stateful_ ones will make your project more suitable for testing, less fragmented and more reliable.
