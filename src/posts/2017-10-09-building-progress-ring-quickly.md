...
If we are using an out-of-the-box solution that provides us with the current progress, like [preloader package by Jam3](//www.npmjs.com/package/preloader) does, building a loading indicator becomes easier.
...
When we update the `progress` prop of the element in our app, Vue takes care of computing the changes and updating the element styles.
